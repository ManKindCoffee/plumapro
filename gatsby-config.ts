...
const config: GatsbyConfig = {
  siteMetadata: {
    ...
    siteTitle: `Pedder`,
    siteTitleAlt: `Pedder - Gatsby Starter Portfolio`,
    siteHeadline: `Pedder - Gatsby Theme from @lekoarts`,
    siteUrl: `https://plumapro.com`,
    siteDescription: `A space for Writing Docs`,
